...
import { Menu, X, Home, Ticket, BarChart3, LogOut, Wifi, Sun, Moon, UserCog, Building2, Users, Wrench } from "lucide-react"
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Configurations", href: "/dashboard/configurations", icon: Wrench },
