...
class SpacesConfig {
  ...
  static const String cdnUrl = 'https://dtg-field-link.sgp1.cdn.digitaloceanspaces.com';
  ...
  static const List<String> allowedPhotoExtensions = ['jpg', 'jpeg', 'png', 'heic'];
  ...
  // - File uploads will fail with "Bucket does not exist"
  // - Photos/videos won't display (wrong CDN URL)
  // - You'll see "Access Denied" errors
  
  // ⚠️ WITHOUT BACKEND SETUP:
  // - Can't upload files (need backend to generate signed URLs)
  // - Backend must have DO_SPACES_ACCESS_KEY and DO_SPACES_SECRET_KEY in .env
  
  // NEXT STEPS:
  // 1. Follow DO_SPACES_SETUP.md guide
  // 2. Create a Space in DigitalOcean
  // 3. Generate API keys
  // 4. Update backend/.env with keys
  // 5. Update values above
  // 6. Configure CORS in Space settings
